...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_WIDER_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_WIDER_val.json',
...
log_level = 'INFO'
work_dir = './work_dirs/wider/retinanet_r50_fpn_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
